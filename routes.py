...
# Verwende 'name' Parameter für eindeutigen Namen, behalte 'admin' für url_for-Kompatibilität
admin_routes = Blueprint('admin', __name__, url_prefix='/admin', name='admin_blueprint')
